...
<m:top item='1_' name='常用操作' display='block'>
  ...
  <m:item name='所有文章列表' link='content_list.php' rank='a_List,a_AccList' target='main' />
  ...
  <m:item name='内容回收站' link='recycling.php' ischannel='1' addalt='清空回收站' addico='images/gtk-del.gif' linkadd='archives_do.php?dopost=clear&aid=no&recycle=1' rank='a_List,a_AccList,a_MyList' target='main' />
</m:top>
